...
tab_tarifario = html.Div([
    ...
    html.Div([
        ...
        style={'display': 'inline-block', 'width': '100%', 'align-items': 'center', 'padding': '20px 20px',
               'margin-bottom': '20px'}
    )
    ])
...
app.layout = html.Div([
    ...
    dcc.Tabs(id="tabs", value='tab-1', children=[
        ...
        dcc.Tab(label='Tendencia Tarifarios', className='metric-title', value='tab-2', style=TAB_STYLE,
                selected_style=TAB_SELECTED_STYLE),
    ]),
